...
@Component({
  selector: 'app-mario-easy',
  templateUrl: './mario-easy.component.html',
  styleUrls: ['./mario-easy.component.css']
})
export class MarioEasyComponent implements OnInit {

  panelOpenState = false;
  rated = true;
  ratingID: string = "61d3b68e89c3923b14647bad";
